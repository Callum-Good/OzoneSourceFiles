...
public class Chair_Controller : MonoBehaviour, IPointerEnterHandler, IPointerExitHandler, IPointerDownHandler
{
    ...
    void Update()
    {
        if (seatState == false)
        {
            seatText.text = "Change Chair To Fabric";
        }
        else
        {
            seatText.text = "Change Chair To Suede";
        }
